...
import { Container, makeStyles, Button, ButtonBase, Paper, Grid, Typography, IconButton, Drawer, List, Divider, ListItem, ListItemIcon, ListItemText } from '@material-ui/core';
...
export let CatalogAll = () => {
    ...
    let remove = (id) => {
        ...
        setData(lodash.without(lodash.values(localStorage), 'INFO').map(JSON.parse));
        setPrice(lodash.sumBy(data, 'price'));
        setMiddlePrice((priceAll / data.length).toFixed(2))
    };
    ...
    return (
        <Container>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} sm container>
                                        <Grid item xs container direction="column" spacing={2}>
                                            ...
                                            <Grid item>
                                                <Button onClick={() => remove(item.id)} color="secondary">Remove</Button>
                                            </Grid>
                                        </Grid>
                                        <Grid item>
            ...
            <Container maxWidth={false} className={classes.info}>
                ...
                <Button onClick={() => removeAll()} color="secondary">Remove All</Button>
            </Container>
        </Container>
    )
};